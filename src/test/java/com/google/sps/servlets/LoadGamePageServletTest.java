...
public final class LoadGamePageServletTest {
    ...
    */
    ...
    public void setUp() throws Exception {
        ...
        servlet = new LoadGamePageServlet();
    }
    ...
    */
    ...
    public void testLoadExisitingGame() throws Exception {
        ...
        datastoreManager.createOrReplaceGame(gamebuilder.build());
        ...
        datastoreManager.createOrReplaceStage(stagebuilder.build());
        ...
        User.Builder userbuilder = new User.Builder("abcUserId").setUsername("abcUsername");
        datastoreManager.createOrReplaceUser(userbuilder.build());

        servlet.doPost(request, response);
        String json = responseWriter.toString();
        Type ReducedGameDataType = new TypeToken<ReducedGameData>(){}.getType();
        ReducedGameData res = new Gson().fromJson(json, ReducedGameDataType);
        
        Assert.assertTrue(res.gameID.equals("abcGameId"));
        Assert.assertTrue(res.gameName.equals("abcGameName"));
        Assert.assertTrue(res.gameDescription.equals("abcGameDescription"));
        Assert.assertTrue(res.creatorUsername.equals("abcUsername"));
        Assert.assertTrue(res.difficulty == 2.0);
        Assert.assertTrue(res.stars == 4.0);
        Assert.assertTrue(res.stageLocations.equals(new ArrayList<Coordinates>(Arrays.asList(new Coordinates(0.0, 0.0), new Coordinates(1.0, 1.0)))));
    }
}
