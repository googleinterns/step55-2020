...
/**
* Servlet that serves the info about a game on its page.
*/
@WebServlet("/load-gamepage-data")
public class LoadGamePageServlet extends HttpServlet {
    ...
    */
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        Game gameobject;
        try {
            gameobject = datastoreManager.retrieveGame(request.getParameter("gameID"));
        } catch(Exception e) {
            gameobject = null;
        }
